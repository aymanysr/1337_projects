...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/20 18:24:01 by ayousr            #+#    #+#             */
/*   Updated: 2025/03/20 18:26:02 by ayousr           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	game->textures.xpm_enemy_left = mlx_load_xpm42(
			"./textures/enemy_left.xpm42");
	...
	game->textures.xpm_enemy_right = mlx_load_xpm42(
			"./textures/enemy_right.xpm42");
